...
## Phase 4 — Technical Layer

| # | Code | Document Name | Function | Status | Priority |
|---:|---|---|---|---|---|
| 15 | SOP-ASM-001 | Inspection, Survey and Sampling Procedure | Core inspection/sampling methodology | Existing SOP1 needs update | P4 |
...
| # | Code | Document Name | Function | Status | Priority |
|---:|---|---|---|---|---|
| 20 | SWMS-ASM-001 | Inspection and Sampling SWMS | Task-specific inspection/sampling controls | Later | P5 |
...
- P4: Technical defensibility critical.
