# Ax4 WHS/SHEQ Document Register

Controlled document register for the Ax4 WHS/SHEQ documentation rebuild.
...
| # | Code | Document Name | Function | Status | Priority |
|---:|---|---|---|---|---|
| 5 | MAN-SHEQ-001 | SHEQ Management Manual | System governance and operating model | To draft | P2 |
| 6 | PRO-DOC-001 | Document Control Procedure | Version, approval, archive and template control | To draft | P2 |
...
| # | Code | Document Name | Function | Status | Priority |
|---:|---|---|---|---|---|
| 15 | SOP-ASM-001 | Asbestos Inspection, Survey and Sampling Procedure | Core asbestos inspection/sampling methodology | Existing SOP1 needs update | P4 |
| 16 | SOP-ASM-002 | Intrusive Investigation Procedure | Intrusive inspection before refurbishment/demolition | To draft | P4 |
| 17 | SOP-ASM-003 | Asbestos Register and Risk Assessment Reporting Procedure | Report generation, QA and issue procedure | To draft | P4 |
...
| # | Code | Document Name | Function | Status | Priority |
|---:|---|---|---|---|---|
| 20 | SWMS-ASM-001 | Asbestos Inspection and Sampling SWMS | Task-specific asbestos inspection/sampling controls | Later | P5 |
| 21 | SWMS-HTS-001 | Working at Heights / Ladder Access SWMS | Height and ladder controls | Later | P5 |
| 22 | SWMS-ELEC-001 | Working Near Electrical Services SWMS | Electrical services controls | Later | P5 |
| 23 | SWMS-CON-001 | Confined Space / Restricted Access SWMS | Confined/restricted space controls | Later | P5 |
| 24 | SWMS-RESP-001 | Respiratory Protection and PPE SWMS | RPE/PPE use and decontamination controls | Later | P5 |
| 25 | FRM-SAMP-001 | Sample Log / Chain of Custody Form | Sample collection and lab submission evidence | Later | P5 |
...
- P1: Corporate/tender critical.
- P2: System governance critical.
- P3: Field control critical.
- P4: Technical asbestos defensibility critical.
- P5: Mature system expansion.
